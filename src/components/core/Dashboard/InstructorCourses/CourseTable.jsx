  ...
  return (
    <>
      <Table className="border rounded-xl border-richblack-800 ">
        <Thead>
          <Tr className="flex px-6 py-2 border-b gap-x-10 rounded-t-md border-b-richblack-800">
                ...
                <Td className="flex flex-1 gap-x-4">
                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    <p className="text-xs text-richblack-300">
                     {course.courseDescription && course.courseDescription.split(" ").length > TRUNCATE_LENGTH
