  ...
  return (
    <div className=''>
      ...
      <div className='relative flex flex-col items-center justify-between w-11/12 mx-auto text-white max-w-maxContent bg-richblack-900'>
        <Link to={"/signup"}>
          <div className='p-1 mx-auto mt-10 mb-5 font-bold transition-all duration-200 rounded-full group bg-richblack-800 text-richblack-200 hover:scale-95 w-fit'>
        ...
        <div className='flex text-3xl font-semibold text-center'>
        ...
        <div className='w-9/12 mx-3 my-12 shadow-blue-200'>
          <video
            muted
            autoPlay
            loop
      ...
      <div className='bg-pure-greys-5 text-richblack-700'>
        <div className='homepage_bg h-[310px] '>
          <div className='flex items-center justify-center gap-5 mx-auto max-w-maxContent h-[300px] flex-col  w-11/12'>
