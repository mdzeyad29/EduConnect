...
export const About = () => {
  return (
    <div className='mx-auto mt-20 md:mt-[100px] text-white'>
    { 
        // section 1
    }
    <section className="py-8 md:py-12 bg-gray-900 px-4">
    <div className="flex flex-col items-center justify-center max-w-4xl mx-auto text-center text-white">
      ...
      <header className="mb-6 md:mb-8">
        ...
        <p className="text-base md:text-lg text-gray-300 px-2">
          EduConnect is at the forefront of driving innovation in online education.
      ...
      <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4">
        <img src={BannerImage1} alt="Banner 1" className="object-cover shadow-lg h-48 sm:h-60 w-full sm:w-96 rounded-xl" />
        <img src={BannerImage2} alt="Banner 2" className="object-cover shadow-lg h-48 sm:h-60 w-full sm:w-96 rounded-xl" />
        <img src={BannerImage3} alt="Banner 3" className="object-cover shadow-lg w-full sm:w-96 h-48 sm:h-60 rounded-xl" />
      </div>
   ...
   <QuoteSection/>
    ...
    <section className="px-4 py-10 md:py-16 text-white bg-gray-950">
  <div className="max-w-6xl mx-auto space-y-10 md:space-y-20">
    ...
    <div className="grid items-center gap-6 md:gap-10 md:grid-cols-2">
      <div>
      <h1 className="mb-4 text-2xl md:text-4xl font-semibold text-pink-600">
      Our Founding Story
    </h1>
      ...
      <div>
        <img
          src={FoundingStory}
          alt="Founding Story"
          className="w-full rounded-2xl shadow-lg object-cover max-h-[300px] md:max-h-[400px]"
        />
      </div>
    </div>
    ...
    <div className="grid gap-6 md:gap-8 md:grid-cols-2">
      {/* Vision Box */}
      <div className="p-4 md:p-8 bg-gray-900 shadow-lg rounded-2xl">
        <h2 className="mb-4 text-2xl md:text-3xl font-semibold text-teal-400 text-blue-25">Our Vision</h2>
        <p className="text-base md:text-lg text-gray-300">
      ...
      {/* Mission Box */}
      <div className="p-4 md:p-8 bg-gray-900 shadow-lg rounded-2xl">
        <h2 className="mb-4 text-2xl md:text-3xl font-semibold text-pink-400">Our Mission</h2>
        <p className="text-base md:text-lg text-gray-300">
